...
void blockmodel:: output_f_ovl(int mode)
{
    ...
    cout<<"###   overlap = "<<compute_overlap_marg()<<", fraction = "<<compute_overlap_fraction()<<endl;/***/
}
//}}}
...
void blockmodel::outputOverlap(string outputOverlapFilename, double epsilon, int Q) {
    ofstream fout;
    fout.open(outputOverlapFilename.c_str(),ios::app);
    fout << epsilon << " " << (compute_overlap_marg()-(1.0/Q))/(1-(1.0/Q)) << endl;
    fout.close();
}
