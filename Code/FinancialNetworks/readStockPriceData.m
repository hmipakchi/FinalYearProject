...
% normalisedVariationInformationMatrix = calculatePairwiseNormalisedVariationInformationAsMatrix([fastNewmanCommunities,montanariCommunities,financialSpectralClusteringCommunities]);