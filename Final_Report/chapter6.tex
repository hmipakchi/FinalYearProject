...
This information implied by {fig:eigenvalueContributionsPC} relates to the intuition that the performance of stocks should decline, as a whole, during a financial crisis, so then the returns will be more positively correlated during this period.
