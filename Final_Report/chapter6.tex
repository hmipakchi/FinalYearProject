...
We believe this setting of time-varying (weighted) network structure is an important application in regard to the process of adapting existing community detection algorithms to moderately-sized, real-world evolving networks.
