...
Then we will discuss one algorithm to optimise generalised modularity in time-dependent networks known as the \emphT{generalised Louvain method}, outlined also in \cite{MRM+10,BPW+13}.
