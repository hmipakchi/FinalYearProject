...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{figures/expectedReturnsAndVolatility.png}
...
The `modified' modualirty method is a spectral clustering algorithm based on the exact same technique considered for binary networks considered in \cref{sec:spectralClustering}, but instead we shall use the filtered correlation matrix, $\matvar{C}^{(g)}$, as input.
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{figures/outputFTSE100FastNewmanMethod.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{figures/outputFTSE100MontanariMethod.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{figures/outputFTSE100FinancialSpectralClusteringMethod.png}
